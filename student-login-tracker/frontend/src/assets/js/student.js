async function updateCourses(semester) {
    ...
    jsonResponse["Course"].forEach(element => {
        ...
        courseInner.href = "assignments.html?" + new URLSearchParams({
            courseId: element["Id"],
        ...
        courseInner.className = "block p-4 no-underline bg-white mb-4 rounded-lg hover:bg-rit-gray transition duration-200 drop-shadow-lg border-2 border-brick-orange"
